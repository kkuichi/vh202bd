...
# Custom class for history saving callback
...
model = load_model("efficientnetb3_best.keras")
...
checkpoint = callbacks.ModelCheckpoint(
    "efficientnetb3_finetuned_best.keras",
    monitor="val_accuracy",
    save_best_only=True
)
csv_logger = CSVLogger("efficientnetb3_finetuned_history.csv", append=True)
...
model.save("efficientnetb3_finetuned_final.keras")
