...
model = tf.keras.models.load_model('./exp1/resnet50_final_model.h5')
with open('./exp1/resnet50_history.json', 'r') as f:
...
checkpoint_fine = callbacks.ModelCheckpoint('resnet50_finetuned_model.keras', monitor='val_loss', save_best_only=True)
...
model.save('./exp2/resnet50_finetuned_model.keras')

with open('./resnet50_finetune_history.json', 'w') as f:
