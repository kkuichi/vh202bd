...
checkpoint = callbacks.ModelCheckpoint('resnet101_model.h5', monitor='val_loss', save_best_only=True)
...
with open(os.path.join(history_dir, 'resnet101_history.json'), 'w') as f:
